 ...
 *          
 *            parser.add_argument('s', "string", "Argument 1", ArgParse::value<std::string>("hello"));
 *            parser.add_argument('f', "float", "Argument 2", ArgParse::value<float>(0.0));
 *            parser.add_argument('b', "boolean", "Argument 3", ArgParse::value<bool>(false));
 ...
 *            
 *            // Flags are always defined on map (as true or false)
